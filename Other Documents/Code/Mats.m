...
Work_done_1 = trapz(Volume, adjustedPressure_1(:,1)) *10^-1;     %% in Jules [J]
...
cycle_6 = table2array(T(:,5));
%cycle_6_single = single(cycle_6);
cycle_1 = table2array(T(:,6));
%cycle_1_single = single(cycle_1);
cycle_10 =table2array(T(:,10));
...
title("Plot of the pV Diagram, E_0, full load")
